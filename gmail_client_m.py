"""
Gamil IMAP client for fetching unread emails.

Uses Python's built-in imaplib to connect to Gmail via IMAP and fetch unread emails from the inbox.
Emails are returned as raw RFC 2822 strings ready for 
...
class RawEmail:
    ...
    Thisis an internal data structure - the public contract is EmailData
...
class GmailClient:
  ...
  # Think of this as setting up security rules for the connection. It tells Python:

  # Verify Gmail's certificate (prove you're really talking to Gmail)
  # Use modern encryption standards
  # Reject suspicious/fake servers
